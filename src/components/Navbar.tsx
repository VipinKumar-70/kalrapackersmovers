  ...
  const navItems = [
    ...
    { name: "About Us", path: "/about" },
    {
      ...
      submenu: [
        ...
        {
          name: "Warehouse and Storage Services",
          path: "/services/Warehouse-and-Storage-Services",
        },
      ],
    },
    { name: "Blog", path: "/blog" },
    { name: "Contact Us", path: "/contact" },
    { name: "Gallery", path: "/NewGallery" },
  ];
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center text-sm sm:text-base">
          ...
          <div className="flex items-center space-x-3 lg:space-x-4">
            ...
            >
              <Facebook
                size={16}
                className="text-white hover:text-yellow-200 cursor-pointer transition-colors duration-200 sm:w-[18px] sm:h-[18px]"
              />
            </a>
            <a
      ...
      <header className="bg-white shadow-lg w-full">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center py-1 sm:py-2">
            ...
            >
              <span
                className="bg-white rounded-lg px-2 sm:px-3 py-1 sm:py-1.5 shadow border border-blue-900 flex flex-col items-center font-extrabold text-blue-900 tracking-widest whitespace-nowrap drop-shadow mr-2 sm:mr-4 lg:mr-8"
                style={{
              ...
              >
                <span
                  className="font-extrabold text-xs sm:text-sm lg:text-base tracking-widest text-blue-900"
                  style={{ letterSpacing: "0.08em", fontFamily: "serif" }}
                >
                  KALRA Packers Movers
                </span>
                <span
                  className="font-bold text-[0.5rem] sm:text-[0.6rem] lg:text-[0.7rem] tracking-widest mt-0.5 px-1 sm:px-2 py-0.5 rounded"
                  style={{
                    background: "#0a2e73",
                    color: "#fff",
                    letterSpacing: "0.2em",
                    boxShadow: "0 1px 4px rgba(10,46,115,0.10)",
                  }}
                >
                  SINCE 1992
                </span>
            ...
            >
              ...
              >
                <Link
                  ...
                  className="w-20 xl:w-24 h-full flex items-center justify-center text-sm xl:text-base font-semibold"
                  onClick={handleNavClick}
                >
                  Get Quote
                </Link>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 space-y-3 sm:space-y-4">
              ...
              <div className="pt-2 sm:pt-4">
                <Button className="w-full bg-gradient-primary hover:shadow-button py-3 sm:py-4 text-base sm:text-lg font-semibold touch-manipulation">
                  <Link to="/contact#quote-form" onClick={handleNavClick}>
                    Get Quote
                  </Link>
                </Button>
              </div>
