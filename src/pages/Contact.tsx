...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone",
      details: ["+91-7292010102", "+91-9810584326"],
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div {...fadeInUp}>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed px-4">
              Ready to move? Get in touch with our expert team for a free quote
              and personalized moving solution tailored to your needs.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <Card className="h-full bg-[#f1f2f6] hover:shadow-card transition-all duration-300 overflow-hidden">
                  <CardContent className="p-0">
                    <div
                      className={`bg-gradient-to-r ${info.color} p-4 sm:p-6 text-white`}
                    >
                    ...
                    <div className="p-4 sm:p-6">
                      {info.details.map((detail, idx) => (
                        <p
                          key={idx}
                          className="text-muted-foreground mb-2 last:mb-0 text-sm sm:text-base leading-relaxed break-words"
                        >
                          {detail}
                        </p>
                      ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            >
              ...
              <Card className="bg-[#f1f2f6]">
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 text-foreground">
                    Why Us?
                  </h3>
            ...
            <motion.div {...fadeInUp} className="order-1 lg:order-2">
              ...
              <form
                ...
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    setError(
                      "Failed to send. Please check your internet connection or try again later."
                    );
                  }
                  setSending(false);
                }}
              >
                ...
                <Button
                  className="w-full bg-primary-glow text-white hover:text-white hover:shadow-button group pt-0 py-3 sm:py-4 text-base sm:text-lg font-semibold touch-manipulation"
                  size="lg"
                  type="submit"
                  disabled={sending}
                >
                ...
                {sent && (
                  <div className="text-green-600 mt-2 text-sm sm:text-base font-medium">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeInUp} className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-muted-foreground px-4">
              Located in the heart of Delhi, easily accessible from all major
              areas
            </p>
          </motion.div>
